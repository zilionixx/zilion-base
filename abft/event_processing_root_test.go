...
func TestZilionBFTClassicRoots(t *testing.T) {
...
func TestZilionBFTRandomRoots(t *testing.T) {
	// generated by codegen4ZilionBFTRandomRoot()
	testSpecialNamedRoots(t, `
 A1.01    
 ║         ║        
 ╠════════ B1.01    
...
func testSpecialNamedRoots(t *testing.T, scheme string) {
	...
	// init abft
	lch, _, input := FakeZilionBFT(nodes, nil)
...
/*
// codegen4ZilionBFTRandomRoot is for test data generation.
func codegen4ZilionBFTRandomRoot() {
	nodes, events := inter.GenEventsByNode(4, 20, 2, nil)

	p, _, input := FakeZilionBFT(nodes)
	// process events
	config := inter.Events{}
